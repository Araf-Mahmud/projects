...
class CustomRAG:
    ...
    def retrieve_documents(self, query:str, trace):
        
        
        with trace.span("embedding generation") as span:
            
            embedded_query = get_embeddings(query) 
        
        with trace.span("query-points") as span:
        ...
        with trace.span("re-ranking") as span:
